  ...
  try {
    ...
    if (type === 'tasks') {
      ...
      const urls = [
        ...
        {
          label: 'Normal',
          url: `https://edusp-api.ip.tv/tms/task/todo?expired_only=false&filter_expired=true&is_exam=false&is_essay=false&with_answer=true&publication_target=${encodeURIComponent(room)}&answer_statuses=pending&with_apply_moment=false`,
        },
      ];
